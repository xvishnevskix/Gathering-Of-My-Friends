...
export const Users = ({ users, isLoading, onChangeValue, searchValue, onClickInvite, invites }) => {
  ...
  return (
    <>
      <div className="search">
        ...
        <input onChange={(event) => onChangeValue(event)} type="text" placeholder="Найти пользователя..." />
      </div>
      {isLoading ? (
